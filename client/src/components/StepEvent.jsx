    ...
    groups: [
      {
        ...
        events: [
          { id: '5k',            label: '5K',                   dist: '5 km',      tiers: { beginner: 0.75, intermediate: 0.45, advanced: 0.22 } },
          { id: '10k',           label: '10K',                  dist: '10 km',     tiers: { beginner: 1.50, intermediate: 0.90, advanced: 0.45 } },
          { id: 'half_marathon', label: 'Half Marathon',         dist: '21.1 km',   tiers: { beginner: 3.50, intermediate: 2.25, advanced: 1.00 } },
          { id: 'marathon',      label: 'Marathon',              dist: '42.2 km',   tiers: { beginner: 7.00, intermediate: 4.50, advanced: 2.02 } },
        ],
      },
      {
    ...
    groups: [
      {
        ...
        events: [
          { id: 'super_sprint',  label: 'Super Sprint',         dist: '400m / 10km / 2.5km',    tiers: { beginner: 1.25, intermediate: 0.85, advanced: 0.50 } },
          { id: 'sprint',        label: 'Sprint Triathlon',     dist: '750m / 20km / 5km',      tiers: { beginner: 2.50, intermediate: 1.50, advanced: 0.95 } },
          { id: 'olympic',       label: 'Olympic / Standard',   dist: '1.5km / 40km / 10km',    tiers: { beginner: 4.50, intermediate: 2.75, advanced: 1.85 } },
          { id: 'half_ironman',  label: 'Ironman 70.3',         dist: '1.9km / 90km / 21km',    tiers: { beginner: 8.50, intermediate: 6.00, advanced: 3.65 } },
          { id: 'ironman',       label: 'Ironman 140.6',        dist: '3.8km / 180km / 42km',   tiers: { beginner: 17.0, intermediate: 12.5, advanced: 7.50 } },
        ],
      },
      {
    ...
    groups: [
      {
        ...
        events: [
          { id: 'cycling_50k',   label: 'Sportive 50km',        dist: '50 km',     tiers: { beginner: 3.00, intermediate: 1.75, advanced: 1.15 } },
          { id: 'cycling_100k',  label: 'Gran Fondo 100km',     dist: '100 km',    tiers: { beginner: 6.00, intermediate: 3.50, advanced: 2.22 } },
          { id: 'cycling_160k',  label: 'Gran Fondo 160km',     dist: '160 km',    tiers: { beginner: 9.00, intermediate: 5.50, advanced: 3.65 } },
          { id: 'cycling_200k',  label: 'Gran Fondo 200km',     dist: '200 km',    tiers: { beginner: 12.0, intermediate: 7.00, advanced: 4.75 } },
        ],
      },
      {
    ...
    groups: [
      {
        ...
        events: [
          { id: 'swim_750m',     label: '750m Open Water',      dist: '750 m',     tiers: { beginner: 0.50, intermediate: 0.30, advanced: 0.15 } },
          { id: 'swim_1500m',    label: '1.5km Open Water',     dist: '1.5 km',    tiers: { beginner: 1.00, intermediate: 0.60, advanced: 0.30 } },
          { id: 'swim_3k',       label: '3km Open Water',       dist: '3 km',      tiers: { beginner: 2.00, intermediate: 1.20, advanced: 0.65 } },
          { id: 'swim_5k',       label: '5km Open Water',       dist: '5 km',      tiers: { beginner: 3.25, intermediate: 2.00, advanced: 1.00 } },
          { id: 'swim_10k',      label: '10km Open Water',      dist: '10 km',     tiers: { beginner: 6.00, intermediate: 4.00, advanced: 1.85 } },
          { id: 'marathon_swim', label: 'Marathon Swim (25km)', dist: '25 km',     tiers: { beginner: 14.0, intermediate: 10.0, advanced: 5.00 } },
        ],
      },
    ],
  },
